        ...
        return <div id='contact' >
            ...
            <div className="social" >
                ...
                <a data-aos="fade-up" data-aos-duration="1000" data-aos-delay="750"  data-aos-anchor=".email"
                 className="icon" href="https://github.com/ramanxg" target="_blank" rel="noopener noreferrer">
                ...
                className="icon" href="https://linkedin.com/in/ramanxg" target="_blank" rel="noopener noreferrer">
                    <svg viewBox="0 0 24 24">
